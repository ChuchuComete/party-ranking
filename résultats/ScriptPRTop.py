...
def entreescoressolo(L,C,E,x1,CL,DL,k,Rang,Total,Titre,Musique, output_path, Top):
    c=len(C)
    N=len(L)
...
# pour le top de Ced
    ...
    if Top==1:
        draw.text((1560,95),str(Top),fill='rgb(255,215,0)', font=font6)
        img.paste(Or,(1595,103),Or) 
    elif Top==2:
        draw.text((1560,95),str(Top),fill='rgb(192, 192, 192)', font=font6)
        img.paste(Arg,(1595,103),Arg) 
    elif Top==3:
        draw.text((1560,95),str(Top),fill='rgb(205, 127, 50)', font=font6)
        img.paste(Bro,(1595,103),Bro) 
    else:
        draw.text((1560,95),str(Top),fill='rgb(255, 255, 255)', font=font6)
...
def entreescores8(L,C,E,x1,CL,DL,k,Rang,Total,Titre,Musique, output_path, Top):
    c=len(C)
    N=len(L)
    img = PIL.Image.open(LayoutPR)
    draw = ImageDraw.Draw(img)
...
def entreescores18(L,C,E,x1,CL,DL,k,Rang,Total,Titre,Musique, output_path, Top):
    c=len(C)
    N=len(L)
    img = PIL.Image.open(LayoutPR)
    draw = ImageDraw.Draw(img)
...
def entreescores36(L,C,E,x1,CL,DL,k,Rang,Total,Titre,Musique, output_path, Top):
    c=len(C)
    N=len(L)
    img = PIL.Image.open(LayoutPR)
    draw = ImageDraw.Draw(img)
    ...
    font4= ImageFont.truetype(Comfortaa, size=35)
    font5= ImageFont.truetype(Comfortaa, size=23)
    font6= ImageFont.truetype(segoesc, size=50)
...
def entreescores54(L,C,E,x1,CL,DL,k,Rang,Total,Titre,Musique, output_path, Top):
    c=len(C)
    N=len(L)
    img = PIL.Image.open(LayoutPR)
    draw = ImageDraw.Draw(img)
    ...
    font3= ImageFont.truetype(Comfortaa, size=45)
    font4= ImageFont.truetype(Comfortaa, size=35)
    font5= ImageFont.truetype(Comfortaa, size=21)
    font6= ImageFont.truetype(segoesc, size=50)
...
# pour le top de Ced
    ...
    if Top==1:
        draw.text((1433,80),str(Top),fill='rgb(255,215,0)', font=font6)
        img.paste(Or,(1468,88),Or) 
    elif Top==2:
        draw.text((1433,80),str(Top),fill='rgb(192, 192, 192)', font=font6)
        img.paste(Arg,(1468,88),Arg) 
    elif Top==3:
        draw.text((1433,80),str(Top),fill='rgb(205, 127, 50)', font=font6)
        img.paste(Bro,(1468,88),Bro) 
    else:
        draw.text((1433,80),str(Top),fill='rgb(255, 255, 255)', font=font6)
...
def creationimagessolo(R,C,Rang,Total,Titre,Musique,output_path, Top):
    E=240 
    x1=130 
    y1=170
    z1=380
    ...
    r=len(R)
    for k in range(r):
        entreescoressolo(R[k],C,E,x1,CL,DL,k+1,Rang[k],Total[k],Titre[k],Musique[k], output_path, Top[k])
    return()

def creationimages8(R,C,Rang,Total,Titre,Musique,output_path, Top):
    E=240 
    x1=130 
    y1=170
    z1=380
    ...
    r=len(R)
    for k in range(r):
        entreescores8(R[k],C,E,x1,CL,DL,k+1,Rang[k],Total[k],Titre[k],Musique[k], output_path, Top[k])
    return()

def creationimages14(R,C,Rang,Total,Titre,Musique,output_path, Top):
    E=145
    x1=50
    y1=170 
    z1=180 
    ...
    r=len(R)
    for k in range(r):
        entreescores14(R[k],C,E,x1,CL,DL,k+1,Rang[k],Total[k],Titre[k],Musique[k], output_path, Top[k])
    return()


def creationimages18(R,C,Rang,Total,Titre,Musique,output_path, Top):
    E=122 
    x1=20
    y1=170 
    z1=180
    ...
    r=len(R)
    for k in range(r):
        entreescores18(R[k],C,E,x1,CL,DL,k+1,Rang[k],Total[k],Titre[k],Musique[k], output_path, Top[k])
    return()

def creationimages36(R,C,Rang,Total,Titre,Musique,output_path, Top):
    E=120
    x1=83
    y1=5
    z1=15
    ...
    r=len(R)
    for k in range(r):
        entreescores36(R[k],C,E,x1,CL,DL,k+1,Rang[k],Total[k],Titre[k],Musique[k], output_path, Top[k])
    return()

def creationimages54(R,C,Rang,Total,Titre,Musique,output_path, Top):
    E=120
    x1=83
    y1=5 
    z1=15
    ...
    r=len(R)
    for k in range(r):
        entreescores54(R[k],C,E,x1,CL,DL,k+1,Rang[k],Total[k],Titre[k],Musique[k], output_path, Top[k])
    return()
